...
- Actualmente este proyecto no usa skills locales, pero los comandos `/goal` y `/learn` de Antigravity están disponibles para expandir comportamientos de manera global.
